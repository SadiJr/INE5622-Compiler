\section{\normalsize CONTRIBUIÇÃO DOS MEMBROS}		
	\begin{table}[h]
		...
		\hline
			...
			& Sadi Júnior Domingos Jacinto & \shortstack{\\Elaboração do Relatório,\\implementação das estruturas \textit{while},\\ \textit{for}, \textit{switch-case}, \textit{if-then-else},\\operações lógicas, definição e chamada de funções}\\\hline
		\end{tabular}
	\end{table}
